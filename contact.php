    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <h5>Get In Touch</h5>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur, fuga.</p>
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="mb-0"><?php echo $k['alamat'] ?> </p>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-4">
                    <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="mb-0"><?php echo $k['no_telp'] ?> </p>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="mb-0"><?php echo $k['instagram'] ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.26661340117!2d100.38663777395895!3d-0.9528406990379564!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd4b90bd1a8788f%3A0x90288b7bbe595a1a!2sMediatama%20Web%20-%20Kursus%20Komputer%2C%20Pembuatan%20Web%20dan%20Mobile!5e0!3m2!1sid!2sid!4v1725333474537!5m2!1sid!2sid" width="100%" height="330" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
